//Verificar la funcionalidad del paginador de la busqueda publica de la Industria electrica.
package busquedaPub;
...
public class PaginadorBusquedaElec {
	public WebDriver driver;
	
	@Test
	public void paginador() throws InterruptedException, IOException {
		...
		try{
			...
			FileUtils.copyFile(scrFile, new File("/home/paty/CapturasPantallaSelenium/busquedaPub/PaginadorBusquedaElec.jpg"));	
		}
	}
